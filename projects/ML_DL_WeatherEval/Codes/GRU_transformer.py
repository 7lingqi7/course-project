...
for output_feature in output_features:
    ...
    # Define GRU-Transformer model architecture
    class GRUTransformerModel(nn.Module):
        def __init__(self, input_dim, hidden_dim, output_dim, num_layers, num_heads, transformer_layers, dropout=0.1):
    ...
    model = GRUTransformerModel(input_dim, hidden_dim, output_dim, num_layers, num_heads, transformer_layers, dropout)
