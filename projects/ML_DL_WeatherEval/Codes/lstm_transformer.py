...
df.rename(columns={'DDATETIME': 'date'}, inplace=True)  # Rename the date column to 'date'
...
for output_feature in output_features:
    ...
    # Define LSTM-Transformer model architecture
    class LSTMTransformerModel(nn.Module):
        def __init__(self, input_dim, hidden_dim, output_dim, num_layers, num_heads, transformer_layers):
        ...
        def forward(self, x):
            ...
            # Taking the last time step output for prediction
    ...
    model = LSTMTransformerModel(input_dim, hidden_dim, output_dim, num_layers, num_heads, transformer_layers)
